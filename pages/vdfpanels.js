        ...
        return (
            <div className="pclPanelsMainContainer">
                ...
                <div className="pclBodyContainer">
                    <p className="pclIntroText"><b>Panelflex provides and assembles a broad variety of motor control panel solutions for any motor control requirement you need. Our motor control panels meet the needs of many applications and conform to NEMA or IEC standards. We offer, contactors, control & load switches, disconnect switches, pump control panels, low voltage starters, reduced voltage starters such as soft starters and variable speed drives.</b></p>
                    ...
                    <p className="pclIntroText"><b>We utilize variable frequency drive products for many applications including our pump control panels and fan control panels in many many Commercial and Municipal applications. We build to suit your design needs providing multi-pole contactor configurations in a various enclosures including NEMA 12, 3R, 4 and 4X.</b></p>
                    <img className="vdfPic2" src="https://firebasestorage.googleapis.com/v0/b/panelflex-7663b.appspot.com/o/products%20%26%20services%2FVFD%20Picture.JPG?alt=media&token=7d7c52b0-6bb4-4765-8076-a5f7b7eb472c"/>
                </div>
